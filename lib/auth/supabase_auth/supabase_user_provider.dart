...
class CustomActionTestSupabaseUser extends BaseAuthUser {
  CustomActionTestSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> customActionTestSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = CustomActionTestSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
